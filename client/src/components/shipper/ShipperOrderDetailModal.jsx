...
/**
 * Shipper Order Detail Modal Component
 */
const ShipperOrderDetailModal = ({ order, onClose, onUpdateStatus }) => {
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex justify-end gap-3">
                    ...
                    {order.status === 'CONFIRMED' && (
                        <button
                            onClick={() => {
                                onUpdateStatus(order.orderId, 'SHIPPING');
                                onClose();
                            }}
...
export default ShipperOrderDetailModal;
