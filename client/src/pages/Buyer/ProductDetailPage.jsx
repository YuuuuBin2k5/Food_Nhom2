...
function ProductDetailPage() {
    ...
    const handleAddToCart = async (isBuyNow = false) => {
        ...
        try {
            ...
            if (isBuyNow) {
                ...
                showToast.success(`Đã thêm ${quantity} suất vào danh sách giải cứu!`);
                setQuantity(1);
            }
        } catch (error) {
    ...
    const getExpiryStatus = () => {
        ...
        return { text: `HSD: ${new Date(product.expirationDate).toLocaleDateString('vi-VN')}`, color: 'bg-emerald-50 text-emerald-700' };
    };
    ...
    const getImageUrl = () => {
        ...
        return `https://via.placeholder.com/600x600/${randomColor}/FFFFFF?text=${encodeURIComponent(product?.name || 'Food')}`;
    };
                        ...
                        <div className="p-8 md:pr-12 flex flex-col">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
                                ...
                                <div className="flex items-center gap-4 text-sm mt-2">
                                    ...
                                    <span className={`px-3 py-1 rounded-full font-medium ${product.quantity > 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'
                                        }`}>
                            ...
                            <div className="mt-auto pt-6 border-t border-gray-100">
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 px-8 py-3 bg-white border-2 border-emerald-500 text-emerald-600 font-bold rounded-xl hover:bg-emerald-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                    ...
                                    <button
                                        ...
                                        disabled={product.quantity === 0 || addingToCart}
                                        className="flex-1 px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl hover:from-emerald-600 hover:to-teal-600 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                        Mua ngay
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <button
                                            ...
                                            className="w-full mt-4 py-2.5 bg-white border border-gray-300 hover:border-emerald-500 hover:text-emerald-600 rounded-xl text-gray-700 font-medium flex items-center justify-center gap-2 transition-all shadow-sm hover:shadow-md active:scale-95"
                                        >
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
