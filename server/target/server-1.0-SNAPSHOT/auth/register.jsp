...
<head>
    ...
    <style>
        ...
        .toggle-password:hover { color: #FF6B6B; }
        .toggle-password svg { width: 20px; height: 20px; pointer-events: none; display: block; }
        .password-wrapper input.form-input { padding-right: 50px !important; }
        ...
        .btn-otp:hover { background: #059669; }
        ...
        @media (max-width: 768px) {
            ...
            .auth-side { width: 100%; min-height: 200px; }
            .auth-form { width: 100%; }
