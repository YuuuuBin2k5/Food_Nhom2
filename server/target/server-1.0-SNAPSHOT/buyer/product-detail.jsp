...
<body>
    ...
    <header class="product-header">
        <div style="max-width: 1280px; margin: 0 auto; padding: 0 1rem; height: 4rem; display: flex; align-items: center;">
            <a href="${pageContext.request.contextPath}/products" style="display: flex; align-items: center; gap: 0.5rem; color: #374151; text-decoration: none; font-weight: 500; transition: color 0.2s;">
    ...
    <c:choose>
                ...
                <div class="product-grid">
                    ...
                    <div>
                        <div class="product-image-section">
                            <img 
                                src="https://placehold.co/600x600/FF6B6B/FFFFFF?text=Food" 
                                alt="${product.name}"
                                class="product-image"
                            >
                            ...
                            <c:if test="${product.quantity == 0}">
                                <div class="out-of-stock-overlay">
                                    <span style="background: white; color: #111827; padding: 0.75rem 1.5rem; border-radius: 9999px; font-weight: 700; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.2);">
                                        Hết hàng
                                    </span>
                                </div>
                            </c:if>
                            ...
                            <div class="shop-card" style="display: none;">
                                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                                    ...
                                    <div style="flex: 1; min-width: 0;">
                                        <h3 style="font-weight: 700; color: #111827; font-size: 1.125rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                    ...
                    <div>
                        ...
                        <div class="price-section">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                                <span class="status-badge ${product.quantity > 0 ? 'badge-green' : 'badge-gray'}">
                                    ${product.quantity > 0 ? 'Còn '.concat(product.quantity).concat(' sản phẩm') : 'Hết hàng'}
                                </span>
                        ...
                        <div class="info-card">
                            ...
                            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                                ...
                                <div class="quantity-control">
                                    <button class="quantity-btn" onclick="changeQuantity(-1)" ${!isAvailable ? 'disabled' : ''}>
                                        <svg style="width: 1.25rem; height: 1.25rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                                        </svg>
                                    </button>
                                    <input type="number" id="quantity" value="1" min="1" max="999" 
                                           class="quantity-input" onchange="validateQuantity()" ${!isAvailable ? 'disabled' : ''}>
                                    <button class="quantity-btn" onclick="changeQuantity(1)" ${!isAvailable ? 'disabled' : ''}>
                                        <svg style="width: 1.25rem; height: 1.25rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                                <button class="btn-add-cart" onclick="addToCart(false)" ${!isAvailable ? 'disabled' : ''}>
                                    <svg style="width: 1.25rem; height: 1.25rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                                    </svg>
                                    <span>Thêm vào giỏ</span>
                                </button>
                                <button class="btn-buy-now" onclick="addToCart(true)" ${!isAvailable ? 'disabled' : ''}>
                                    Mua ngay
                                    <svg style="width: 1.25rem; height: 1.25rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <c:if test="${not empty product.seller}">
                            <div class="shop-card">
                                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                                    <div class="shop-avatar" style="width: 3.5rem; height: 3.5rem; font-size: 1.25rem;">
                                        ${product.seller.shopName.substring(0, 1).toUpperCase()}
                                    </div>
                                    <div style="flex: 1; min-width: 0;">
                                        <h3 style="font-weight: 700; color: #111827; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                            ${product.seller.shopName}
                                        </h3>
                                        <div style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.875rem; color: #6b7280;">
                                            <span>🏪</span>
        ...
        <c:otherwise>
            <div style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 1rem;">
                ...
                <h2 style="font-size: 1.5rem; font-weight: 700; color: #1f2937; margin-bottom: 0.5rem;">Không tìm thấy sản phẩm</h2>
                <a href="${pageContext.request.contextPath}/products" style="margin-top: 1rem; padding: 0.5rem 1.5rem; background: #3b82f6; color: white; border-radius: 0.5rem; text-decoration: none; transition: background 0.2s;">
                    Quay lại danh sách
                </a>
            </div>
        </c:otherwise>
