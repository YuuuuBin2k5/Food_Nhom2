...
<header class="sidebar" id="sidebar">
    <div class="sidebar-container">
        ...
        <a href="${pageContext.request.contextPath}/" class="logo-link">
            <div class="logo-icon">
                <div style="position: absolute; inset: 0; background: linear-gradient(to top, rgba(234, 88, 12, 0.2), transparent);"></div>
                <span style="position: relative; z-index: 10; font-size: 1.5rem; filter: drop-shadow(0 1px 2px rgba(0,0,0,0.1));">🍊</span>
            </div>
            <div class="logo-text">
        ...
        <div class="right-actions">
            ...
            <c:if test="${sessionScope.role == 'BUYER' || empty sessionScope.role}">
                <a href="${pageContext.request.contextPath}/cart" class="cart-btn">
                    <svg style="width: 1.25rem; height: 1.25rem; color: #c2410c;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <c:if test="${not empty sessionScope.user}">
                <div style="position: relative;">
                    <button class="profile-btn" onclick="toggleDropdown()">
                        ...
                        <svg style="width: 1rem; height: 1rem; color: #c2410c; display: none;" class="sm-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <c:if test="${empty sessionScope.user}">
                <div style="display: none; align-items: center; gap: 0.75rem;" class="sm-flex">
                    <a href="${pageContext.request.contextPath}/login" style="padding: 0.625rem 1.25rem; font-size: 0.875rem; font-weight: 600; color: #c2410c; transition: color 0.2s; text-decoration: none;">
                        Đăng nhập
                    </a>
                    <a href="${pageContext.request.contextPath}/register" style="padding: 0.625rem 1.25rem; font-size: 0.875rem; font-weight: 700; background: linear-gradient(to right, #f97316, #f59e0b, #eab308); color: white; border-radius: 0.5rem; transition: all 0.2s; text-decoration: none;">
                        Đăng ký
                    </a>
                </div>
            </c:if>
    ...
    <div class="mobile-menu" id="mobileMenu" style="display: none;">
        ...
        <c:if test="${empty sessionScope.user}">
            <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(251, 146, 60, 0.5); display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.75rem; padding-left: 1rem; padding-right: 1rem;">
                <a href="${pageContext.request.contextPath}/login" style="display: flex; justify-content: center; padding: 0.75rem; border: 2px solid #fdba74; color: #c2410c; border-radius: 0.5rem; font-weight: 600; transition: all 0.2s; text-decoration: none;">
                    Đăng nhập
                </a>
                <a href="${pageContext.request.contextPath}/register" style="display: flex; justify-content: center; padding: 0.75rem; background: linear-gradient(to right, #f97316, #f59e0b, #eab308); color: white; border-radius: 0.5rem; font-weight: 700; transition: all 0.2s; text-decoration: none;">
                    Đăng ký
                </a>
            </div>
        </c:if>
