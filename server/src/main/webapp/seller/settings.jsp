...
<html lang="vi">
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/css/seller_style.css"
    />
    <link
      rel="stylesheet"
    ...
    <main class="seller-main seller-main-narrow">
      <div class="settings-container">
        ...
        <div class="settings-content">
          ...
          <form
            action="${pageContext.request.contextPath}/seller/settings"
            method="post"
            class="settings-form"
          >
            ...
            <div class="settings-form-group">
              <label class="settings-label"
                >Giấy phép kinh doanh (Link ảnh)</label
              >
              <input
                type="url"
                name="businessLicenseUrl"
                id="licenseUrl"
                value="${user.businessLicenseUrl}"
                class="settings-input"
                placeholder="https://..."
                onchange="previewImage(this.value)"
              />
              <small class="settings-note"
                >* Lưu ý: Việc thay đổi giấy phép có thể khiến tài khoản phải
                chờ Admin duyệt lại.</small
              >

              <div class="settings-preview">
                <img
                  id="licensePreview"
                  src="${user.businessLicenseUrl}"
        ...
        <div class="settings-footer">
          ...
          <span
            class="status-badge status-${user.verificationStatus.toString().toLowerCase()}"
          >
