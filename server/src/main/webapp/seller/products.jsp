                                                ...
                                                <tbody>
                                                    <c:forEach var="product" items="${products}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge ${product.quantity > 0 ? 'badge-success' : 'badge-danger'}">
                                                                    ${product.quantity}
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when test="${product.status == 'ACTIVE'}">
                                                                        <span class="badge badge-success">✅ Đang
                                                                            bán</span>
                                                                    </c:when>
                                                                    <c:when
                                                                        test="${product.status == 'PENDING_APPROVAL'}">
                                                                        <span class="badge badge-warning">⏳ Chờ
                                                                            duyệt</span>
                                                                    </c:when>
                                                                    <c:when test="${product.status == 'REJECTED'}">
                                                                        <span class="badge badge-danger">❌ Từ
                                                                            chối</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <span
                                                                            class="badge badge-secondary">${product.status}</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <c:if test="${product.status == 'ACTIVE'}">
                                                                        <button
                                                                            onclick="toggleProductStatus(${product.productId}, 'INACTIVE')"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category" name="category" class="form-control" required>
                                            ...
                                            <c:forEach var="cat" items="${categories}">
                                                <option value="${cat.name()}">${cat.getDisplayNameWithEmoji()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
