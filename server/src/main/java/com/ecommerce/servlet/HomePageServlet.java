...
/**
 * Home page servlet - displays all products with filtering capability
 * This is the main landing page for buyers
 */
...
public class HomePageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Set menu items
        MenuHelper.setMenuItems(request, role != null ? role : "BUYER", "/");
        ...
        try {
            ...
            // Forward to home JSP (not products.jsp)
